...
sydIP=`aws ec2 describe-instances --instance-ids $instance_id --output text --query 'Reservations[*].Instances[*].PublicIpAddress'`
echo "IP address aquired: $caliIP"
echo "creating ssh tunnel..."
ssh -i ~/jjs2-kp2.pem -D 1337 -f -C -q -N ubuntu@$sydIP -p 22
...
curl --socks5-hostname 127.0.0.1:1337 ifconfig.co